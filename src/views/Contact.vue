<template>
  ...
  <div class="contact">
    <div class="des">
      <div class="t-1">Need Help?</div>
      <div class="t-2">
        Gamecoca will respond to all of your requests. Contact us using one of the methods
        listed below.
      </div>
    </div>
    <!-- <div class="live-btn">
    ...
    <div class="des">
      <div class="t-1" style="margin-bottom: 0">We value your feedback</div>
    </div>
