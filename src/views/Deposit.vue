      ...
      <div class="withdraw-able">
        ...
        <div class="withdraw-box">
          ...
          >
            ...
            <Checked
              v-if="item.id == withdraw_form.id"
              width="0.333rem"
              color="#FFC536"
            />
            <CheckNormal v-else width="0.333rem" color="#FFC536" />
          </div>
            ...
            <nut-form-item prop="accountType">
              <div class="ipt-box">
                ...
                <div class="options-box" @click="showPixType = !showPixType">
                  ...
                  <ArrowDown2 width="0.555rem" color="#ffffff" />
                </div>
...
import { Close, CheckNormal, Checked, ArrowDown2 } from "@nutui/icons-vue";
import {
  WithdrawalInfo,
  GetRechargeActivity,
  GetTranscationInfo,
